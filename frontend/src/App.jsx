  ...
  return (
    <div className="app-shell">
      ...
      <header className="hero">
        <div>
          <p className="eyebrow">NFT + Governance dApp</p>
          <h1>Creator Collective</h1>
          <p className="hero-copy">
            Ijodkorlar uchun mint, metadata boshqaruvi va hamjamiyat voting oqimini bitta Web3 interfeysda jamlaydi.
          </p>
        </div>
                ...
                return (
                  <article className="proposal-card" key={proposal.id}>
                    ...
                    <div className="proposal-actions">
                      ...
                      <button type="button" className="secondary" onClick={() => vote(proposal.id, false)} disabled={isBusy || !walletAddress || isClosed}>
                        Vote No
                      </button>
                      <button
                        type="button"
